...
== Changelog ==
= 3.9.3 =
* Fixed SQL bug in a query that removes the unused relationship of a question with category.
* Fixed issue with radio buttons in settings.

= 3.9.2 =
* Added remove button to the uploaded file in the question form.
* Fixed bug with replace comments while save post and replace comments categories
* Changed related with the Idea Stimulator addon.
* Add option to show the question title inside the_content()
* Fixed problem with showing title.

= 3.9.1 =
* Added fix for social login

= 3.9.0 =
* Added option: Default email recipient when using BCC to solve some problems with sending email to the undisclosed recipients.
* Internal changes in the Labels in order to make compatible with some addons.

= 3.8.0 =
* Added googleoff comment tags to avoid indexing the plugin buttons by Google.
* Fixed problem with required categories and two-level categories choosing.

= 3.7.1 =
* Fixed bug in micropayments integration.
* Added new labels.
* Updated licensing library.

= 3.7.0 =
* Added new shortcode cma-favorite-questions that shows the questions marked by the current user as favorite.
* Added new parameter favorite=1 to cma-questions shortcode.
* Updated shortcodes list page. 
* Fixed validating the attachment's extension (removing spaces).

= 3.6.8 =
* Fixed add question form validation;
* Fixed validation message for shortcode add question form;

= 3.6.7 =
* Fixed in Anonymous Posting integration (showing email address of the anonymous user).

= 3.6.6 =
* Added some hooks for the customer's customization.
* Fixed bug in related CMA questions.
* Fixed PHP error on the contrubutors page.

= 3.6.5 =
* Fixed issue with licensing library.

= 3.6.4 =
* Fixed issue with answers number not showing.
* Updated licensing package.

= 3.6.3 =
* SQL queries optimiations.
* Improvent for the metabox code.

= 3.6.2 =
* Restored replace comments feature for all post types.
* Fixed issue with AJAX in shortcode.
* Fixed multibyte substr issue.
* Added nofollow to login links.

= 3.6.1 =
* Fixed problem with filtering the default stage.
* Updated shortcodes page in the plugin backend e.g. added cma-answers shortcode description to the shortcodes page.
* Made a separate meta box for the Replace comments features on the edit post page.
* Fixed bug with settings filter field.
* Fixed CSS issue on the license page. 

= 3.6.0 =
* Added new shortcode cma-get-param-author which takes the "author" parameter from the URL address.
* Allowed to use cma-get-param-author shortcode inside the cma-questions and cma-answers shortcodes.
* Added option to allow or disallow comments in the resolved thread.
* Fixed issue with experts visibility filter.
* Fixed issue with backlink in my answers shortcode.
* Fixed the title issue.

= 3.5.0 =
* Added option to hide the question sorting links.
* Added basic notification check feature to cma and cmdm to check if sending emails works.
* Fixed issue with visibility.

= 3.4.0 =
* Added the question stages that can be set by admin.
* Added email notifications for the question, answer and comments refused by moderator.
...
= 3.3.3 =
* Fixed issue with the Thrive Lightbox.
* Updated licensing package.

= 3.3.2 =
* CSS improvements.
* Fixed issue with sorting answers by highest rating.
* Added option to not include wp-editor-class.

= 3.3.1 =
* Fixed bug with ajax URL.

= 3.3.0 =
* CSS changes.

= 3.2.0 =
* Added the look and feel additional style setting.
* Improved the Shortcodes description page.
* Added ability to delete attachments for questions and answers.
* Changes related with the new EDD payments addon.
* Changes related with the Experts addon update.
...
= 3.1.9 =
* Fixed issue with anonymous posting nicknames. 

= 3.1.8 =
* Fixed issue with scheduled placeholder CMA page.
...
= 3.1.5 =
* Add the option not show the index order Newest/Hottest/Most in the index page 

= 3.1.4 =
* Updated Facebook Login app callback URL information which was incorrect.
...
= 3.1.1 =
* Fixed issue with formatting when posting and edtting the answers.

= 3.1.0 =
* Added user's badges depending on the user's Micropayments points number.
* Prepared integration with the CMA Peepso Addon.
* Added the widget option to hide the anonymous user in the Top Contributors widget.
* Added the setting to show the Forgot password link in the Login Widget.
