...
require_once CMA_PATH . '/lib/models/DebugLog.php';
require_once CMA_PATH . '/lib/models/User.php';
...
require_once CMA_PATH . '/lib/helpers/shortcodes/TopicBoard.php';
...
require_once CMA_PATH . '/lib/helpers/RejectedContentNotification.php';
...
require_once CMA_PATH . '/lib/helpers/MicroPayments/MicroPaymentsBadges.php';
require_once CMA_PATH . '/lib/helpers/SettingsViewAbstract.php';
require_once CMA_PATH . '/lib/helpers/Ads.php';
require_once CMA_PATH . '/lib/helpers/QuestionQuery.php';
