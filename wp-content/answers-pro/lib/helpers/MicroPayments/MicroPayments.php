...
// 		var_dump($result);exit;
	...
	public function getAnswerPoints()
	{
		...
		return apply_filters('cma_micropayments_get_answer_points', $points);
	}
	...
	static function getUserBallance($userId) {
		$code = apply_filters('cm_micropayments_user_wallet_code', $userId);
		if ($code) {
			$wallet = apply_filters('cm_micropayments_get_wallet_by_code', $code);
			if ($wallet AND !empty($wallet->points)) {
