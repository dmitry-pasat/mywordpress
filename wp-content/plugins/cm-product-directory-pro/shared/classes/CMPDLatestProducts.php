<?php
	class CMPDLatestProducts extends WP_Widget
	{
		...
		{
			$widget_latest_products = array(
				'classname' 	=> 'CMPDLatestProducts',
				'description'	=> 'Show latest products.',
				);

				parent::__construct( 'cmpd_latest_products', 'CM Product Directory - Latest Producst', $widget_latest_products );
		}
		...
		public function widget( $args, $instance )
		{
			if ( CMProductDirectory::$isLicenseOK )
			{
				...
				$query 		 = wp_get_recent_posts( $queryArgs,'OBJECT' );
				$terms 		 = $query;
