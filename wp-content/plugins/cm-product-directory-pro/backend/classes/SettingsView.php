<?php
include_once CMPD_PLUGIN_DIR . 'backend/classes/SettingsViewAbstract.php';

class CMPD_SettingsView extends CMPD_SettingsViewAbstract
{
    ...
    protected function getSubcategoryTitle($category, $subcategory)
    {
        ...
        {
            return CMProductDirectory::__($subcategories[$category][$subcategory]);
        }
        else
        {
            return $subcategory;
    ...
    {
        return apply_filters('cmpd_settings_pages', CMPD_Settings::$categories);
    }

    protected function getSubcategories()
    {
        return apply_filters('cmpd_settings_pages_groups', CMPD_Settings::$subcategories);
    }
