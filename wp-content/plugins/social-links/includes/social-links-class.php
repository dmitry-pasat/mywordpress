...
class Social_Links_Widget extends WP_Widget {
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance = array(
            ...
            'facebook_icon' => (!empty($new_instance['facebook_icon']))? strip_tags($new_instance['facebook_link']): '',
    ...
    public function getForm( $instance ) {
        ...
        <h4>Facebook</h4>
        <p>
            <label for="<?php echo $this->get_field_id('facebook_link'); ?>"><?php _e('Link', 'sl_domain'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('facebook_icon'); ?>"><?php _e('Icon', 'sl_domain'); ?></label>
        ...
        <h4>Twitter</h4>
        <p>
            <label for="<?php echo $this->get_field_id('twitter_link'); ?>"><?php _e('Link', 'sl_domain'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter_icon'); ?>"><?php _e('Icon', 'sl_domain'); ?></label>
        ...
        <h4>Linkedin</h4>
        <p>
            <label for="<?php echo $this->get_field_id('linkedin_link'); ?>"><?php _e('Link', 'sl_domain'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('linkedin_icon'); ?>"><?php _e('Icon', 'sl_domain'); ?></label>
        ...
        <h4>Google+</h4>
        <p>
            <label for="<?php echo $this->get_field_id('google_link'); ?>"><?php _e('Link', 'sl_domain'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('google_icon'); ?>"><?php _e('Icon', 'sl_domain'); ?></label>
    ...
    /**
     * Gets and dispays Social Links
     *
     * @param array $links Social Links
     * @param array $icons Social Icons
     * @param array $icon_width Social Width of Icons
     */
